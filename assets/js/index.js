window.onload = function(){
	...
	if (filters.length) {
        ...
        // màn hình hiển thị 5 sản phẩm
		var soLuong = (window.innerWidth < 1200 ? 8 : 10); 
...
// thêm các sản phẩm từ biến mảng vào trang
...
function alertNotHaveProduct(coSanPham) {
	...
	if (!coSanPham) {
		...
		thongbao.style.transitionDuration = ".5s";
